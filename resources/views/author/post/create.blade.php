																...
																<div class="card">
																				<div class="card-body">
																								<form method="POST" action="{{ route('author.posts.store') }}" enctype="multipart/form-data"
																												...
																												<div class="form-group">
																																<label class="text-dark display-6" for="post_title">What is the Title of your
																																				article</label>
																												...
																												<div class="form-group">
																																<label class="text-dark display-6" for="post_subtitle">What is the Subtitle of your
																																				article</label>
																																...
																																<textarea type="heading" name="post_subtitle" class="form-control @error('post_subtitle') is-invalid @enderror"
																																    id="post_subtitle" aria-describedby="emailHelp" placeholder="Enter the subtitle of your article"
																												...
																												<div class="form-group">
																																<label class="text-info" for="exampleFormControlTextarea1">Click on proceed to create Your
																																				Article</label>
																																<div class="row">
